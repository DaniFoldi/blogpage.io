const debug = require('debug')('blogpage.io:tools:get_header_right_data')

const get_author = require('./get_author')
const get_metadata = require('./get_metadata')

module.exports = async settings => {
  const header_right_data = await Promise.all(settings.header_right.map(async el => {
    return el.category ? {
